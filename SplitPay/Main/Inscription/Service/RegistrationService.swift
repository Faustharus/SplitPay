            ...
            Future { promise in
                ...
                Auth.auth()
                    ...
                    .createUser(withEmail: details.email, password: details.password) { res, error in
                        ...
                        let storageProfileRef = storageRef.child("profile").child("\(String(describing: res?.user.uid))")

                        storageProfileRef.putData(imageData, metadata: nil, completion: {
                            ...
                            storageProfileRef.downloadURL { (url, error) in
                                ...
                                if let uid = res?.user.uid {
                                    ...
                                    db.collection("users").document(uid).setData([
                                        ...
                                        RegistrationKeys.profilePicture.rawValue: downloadURL,
